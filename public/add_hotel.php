<?php require_once("../includes/db_connection.php");
	...
	if(isset($_POST["submit"])){
								...
								if(empty($errors))
								{	$maxlength=array("name" =>20,"description" =>5000,"short_description" =>250);
								...
								if(empty($errors))
									{
										...
										if(isset($_POST["short_description"])){
																		...
																		$short_description=query_prep(html_prep($_POST["short_description"]));
																		  }
										...
										if(isset($_POST["thumb_image"])){
																	$thumb_image=query_prep(html_prep($_POST["thumb_image"]));
																   }
...
<form action="add_hotel.php?destination=<?php echo $destination["id"];?>" method="post">
         <tr><td><h1>Add Hotel</h1></td></tr>
         	<tr><td><p>Hotel name:</p></td><td>
            	<input type="text"  name="hotel_name" value="<?php if(isset($_POST["hotel_name"])){ echo html_prep($_POST["hotel_name"]);
																										} ?>"/>
            </td></tr>
            ...
            <tr><td>Position:</td><td>
                ...
                <?php
					...
					for($count=1;$count<=$hotel_count+1;$count++){
						echo"<option value=\"{$count}\"";
							if(isset($_POST["position"])&&$_POST["position"]==$count){echo " selected";
																						}
           ...
           <tr><td><p>Short Description</p></td><td>
            	<textarea name="short_description" value="" rows="6" cols="30" style="width:280px;"><?php if(isset($_POST["short_description"])){echo html_prep($_POST["short_description"]);	
																																		} ?></textarea>
            </td></tr>
            ...
            <tr><td><p>Description</p></td><td>
            	<textarea name="description" value="" rows="10" cols="60" style="width:494px;"><?php if(isset($_POST["description"])){echo html_prep($_POST["description"]);	
																							} ?></textarea>
            </td></tr>
             
            <tr><td><input type="submit" name="submit" value="Create Hotel"/>
            </td></tr>
         </form>
</table>	
</div><!--ba-->
